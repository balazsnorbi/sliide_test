...
import com.norbert.balazs.sliidechallangeapp.databinding.ListItemBinding
import com.norbert.balazs.sliidechallangeapp.domain.model.User

class UserVH(private val layout: ListItemBinding) : RecyclerView.ViewHolder(layout.root) {
